...
class ReservationPage extends Component {
  ...
  areas = ["Forest Reserve", "Wetland Sanctuary", "Mountain Park", "Desert Reserve"];
  ...
  handleSubmit = () => {
    ...
    if (selectedArea && selectedTime) {
      ...
      if (isAlreadyReserved) {
        ...
        this.setState({
          reservations: [...reservations, { area: selectedArea, time: selectedTime }],
          selectedArea: "",
          selectedTime: "",
          isTimeLocked: false,
        });
  ...
  render() {
    const { selectedArea, selectedTime, reservations, isTimeLocked } = this.state;
